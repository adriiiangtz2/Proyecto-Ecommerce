...
<div id="ventana-modalacceso<?=$user->id?>" class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal-body-editar" style="border:1px dashed;">
                ...
                <div class="row" style="">
                    ...
                    <div class="col-md-3 ">
                        ...
                        <p><b> <?= $form->field($user, 'username')->textInput(['maxlength' => 255, 'autocomplete'=>'off','id' => 'user-username']) ?>
                            </b></p>
                    </div>
                    <div class="col-md-3">
                        <!--  // TODO solo la contra no trae datos para mostrar en input pero si para agregar y editar -->
                        <p><b> <?= $form->field($user, 'password')->passwordInput(['maxlength' => 255, 'autocomplete'=>'off','id' => 'user-password']) ?>
                            </b></p>
                    </div>
                    <div class="col-md-3">
                        <p><b>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="eliminar-btn-tarjeta" onclick="editaracceso(<?=$user->id ?>)">Guardar <i
