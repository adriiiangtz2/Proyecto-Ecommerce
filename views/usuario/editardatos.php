...
<div id="ventana-modalusu<?= $usuario->usu_id ?>" class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal-body-editar" style="border:1px dashed;">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <p><b>
                                <?= $form->field($usuario, 'usu_nombre')->textInput(['maxlength' => true, 'id' => 'usu-nombre']) ?></b>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p><b>
                                <?= $form->field($usuario, 'usu_paterno')->textInput(['maxlength' => true, 'id' => 'usu-paterno']) ?></b>
                        </p>
                    </div>
                    <div class="col-md-3">
                        <p><b><?= $form->field($usuario, 'usu_materno')->textInput(['maxlength' => true, 'id' => 'usu-materno']) ?></b>
                        </p>
                    </div>
                </div>
                <?php ActiveForm::end(); ?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="eliminar-btn-tarjeta"
                    onclick="editarUnion(<?= $usuario->usu_id ?>)">Guardar <i class="far fa-save"></i></button>
            </div>
        </div>
    </div>
